...
export const navigationItems: NavItem[] = [
  // --- Основное ---
  { path: '/', label: 'Аналитика', section: 'main', roles: [UserRole.SUPER_ADMIN, UserRole.OWNER, UserRole.MANAGER, UserRole.WAITER], icon: 'chart', priority: 0 },
  ...
  { path: '/reports', label: 'Отчёты', section: 'analytics', roles: [UserRole.SUPER_ADMIN, UserRole.OWNER, UserRole.MANAGER, UserRole.WAITER], icon: 'document', priority: 2 },
