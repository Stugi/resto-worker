<template>
  <div>
    ...
    <div
      v-if="success"
      class="bg-status-green-bg border border-status-green-border text-status-green-text px-4 py-3 rounded mb-6"
      role="alert"
    >
    ...
    <div class="mt-8 pt-6 border-t border-border">
      ...
      <div class="text-center">
        <NuxtLink
          ...
          class="inline-flex items-center justify-center px-4 py-2 border border-border-input rounded-lg text-sm font-medium text-text hover:bg-bg-hover transition-colors"
        >
