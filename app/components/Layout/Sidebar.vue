                ...
                <ClientOnly>
                    <div class="flex items-center gap-2.5 px-3 py-2">
                        ...
                        >
                            ...
                            <span
                                v-if="notifBadgeColor !== 'hidden'"
                                :class="[
                                    'absolute -top-0.5 -right-0.5 w-4 h-4 text-white text-[10px] font-bold rounded-full flex items-center justify-center',
                                    notifBadgeColor === 'red' ? 'bg-danger' : 'bg-orange-500'
                                ]"
                            >
                                {{ notifCount }}
                            </span>
...
const { count: notifCount, badgeColor: notifBadgeColor } = useNotifications();
